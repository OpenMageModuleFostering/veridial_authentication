...
/**
 * Veridial indext controller
 *
 * @category   Veridial
 * @package    Liquid11_Veridial
 * @author     Veridial <https://www.veridial.co.uk/>
 */
class Liquid11_Veridial_IndexController extends Mage_Core_Controller_Front_Action
{
	/**
	 * Veridial entry point
	 * Load layout XML an render page
	 */
